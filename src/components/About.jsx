        ...
        <div className="about-container">
            ...
            <div className="flex-about">
                <div className="about-text">
                    ...
                    <p>
                    I am passionate about both food, computers, and the outdoors. The former of which led me to a successful 15 year career in food service management. My next step, however, is to transition into the field of software devlopment. I'm excited to see where this journey takes me, and can't wait to leverage my skills against new problems!
                    </p>
